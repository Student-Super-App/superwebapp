...
import { useProduct, useIncrementViews, useSimilarProducts, useCreateChat } from '@/features/marketplace/hooks';
                  ...
                  {product.images && product.images.length > 1 && (
                    <div className="p-4 grid grid-cols-4 gap-2">
                      {product.images.slice(1, 5).map((img, idx) => (
                        <div key={idx} className="relative aspect-square bg-gray-100 dark:bg-gray-900 rounded-lg overflow-hidden">
                          <Image
                            src={img}
